...
namespace base
{
    ...
    struct JointState
    {
        ...
        JointState()
            : position(base::unset<double>()), speed(base::unset<float>()), effort(base::unset<float>()), raw(base::unset<float>()), acceleration(base::unset<float>()) {}
    ...
    struct JointStateTypeInfo
        : public RTT::types::StructTypeInfo<JointState, true>
    {
        JointStateTypeInfo();
    };
...
namespace boost
{
    namespace serialization
    {
        ...
        void serialize(Archive &a, JointState &wp, unsigned int);
